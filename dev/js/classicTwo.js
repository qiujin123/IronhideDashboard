...
classicTwoTL.to("#auto16", {duration:1, alpha: 0},"fadeOut")
            ...
            .from("#leftHandleDownView",{ duration:guardViewSpeed, alpha:0},"guardView") 
            .from("#rightHandleDownView",{ duration:guardViewSpeed, alpha:0},"guardView") 
            .from("#leftHandleUpView",{ duration:guardViewSpeed, alpha:0},"guardView") 
            .from("#rightHandleUpView",{ duration:guardViewSpeed, alpha:0},"guardView") 
