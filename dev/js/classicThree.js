...
classicThreeTL.from("#energonBar", {duration:0.7, alpha: 0},"fuel")
              ...
              .from("#activateButton", {duration:0.5, alpha:0, scale:0, y:520},"buttonOut")
              .from("#cameraButton", {duration:0.5, alpha:0, scale:0, x:720},"buttonOut")
              .from("#settingButton", {duration:0.5, alpha:0, scale:0, x:160},"buttonOut")
              .from("#homeButton", {duration:0.5, alpha:0, scale:0, x:720},"buttonOut2")
              .from("#phoneButton", {duration:0.5, alpha:0, scale:0, x:160},"buttonOut2")
              .from("#musicButton", {duration:0.5, alpha:0, scale:0, x:720},"buttonOut3")
              .from("#navigationButton", {duration:0.5, alpha:0, scale:0, x:160},"buttonOut3")
