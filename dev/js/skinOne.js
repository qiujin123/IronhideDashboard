...
skinOneTL.to("#leftGuard", {duration:0.5, morphSVG:"#skinleftGuard", y:97, x:-307},"skinChange")
         ...
         .from("#skinCameraView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinCameraIcon", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinMusicView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinMusicIcon", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinSettingView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinSettingIcon", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinHomeView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinHomeIcon", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinPhoneView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinPhoneIcon", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinNavView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinNavigationIcon", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinWeaponView", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinSword", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinLeft", {duration:0.3, alpha:0},"skinIcon")
         .from("#skinRight", {duration:0.3, alpha:0},"skinIcon")