...
speedTL.to("#skinMph1",{ duration: 0.5, fill:"#D34F47", onStart: startTimer})
	   ...
	   .to("#skinMph2",{ duration: 0.5, fill:"#CF4037"},"one")
	   .from("#rpmOne",{ duration: 0.3, alpha:0 },"one")
	   .to("#skinRpm1",{ duration: 0.5, fill:"#279DDC"},"one")
	   .to("#rpmOne",{ duration: 0.3, alpha:0})
	   .to("#skinMph3",{ duration: 0.5, fill:"#C3382F"},"two")
	   .from("#rpmTwo",{ duration: 0.3, alpha:0 },"two")
	   .to("#skinRpm2",{ duration: 0.5, fill:"#2192CE"},"two")
	   .to("#rpmTwo",{ duration: 0.3, alpha:0})
	   .to("#skinMph4",{ duration: 0.5, fill:"#B4332B"},"three")
	   .from("#rpmThree",{ duration: 0.3, alpha:0 },"three")
	   .to("#skinRpm3",{ duration: 0.5, fill:"#1F86BD"},"three")
